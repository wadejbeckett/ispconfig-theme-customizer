...
class page_action extends tform_actions {
    ...
    private $branding_keys = array('logo_url', 'logo_url_on_dark', 'logo_variant_nav', 'logo_variant_login', 'favicon_url', 'accent_hex', 'rail_hex', 'login_bg', 'show_ispconfig_credit', 'show_theme_credit', 'show_version', 'show_design');
    ...
    function onShowEdit() {
        ...
        if($app->tform->errorMessage == '') {
            ...
            $this->dataRecord = array(
                ...
                'show_design'           => (isset($branding['show_design']) && $branding['show_design'] === '0') ? '0' : '1',
