...
//* names, but sys_user.modules is read back, re-joined and written whole, so a
//* mismatched charset is the difference between a lossless round trip and MySQL
//* replacing characters it cannot represent with '?'. Every raw mysqli connection in
//* this project pins utf8mb4 for that reason.
